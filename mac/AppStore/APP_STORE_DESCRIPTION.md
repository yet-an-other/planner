# Planner App Store Description

## App Name
Planner

## Subtitle
Year view for Google Calendar

## Promotional Text
See your entire year at a glance, stay synced with Google Calendar, and keep your last loaded events available when you are offline.
...
- Full-year calendar view in a single screen flow
- Read-only Google Calendar sync
- Clear display for multi-day trips, stays, and deadlines
...
## Keywords
calendar, planner, year view, google calendar, schedule, events, agenda, productivity
